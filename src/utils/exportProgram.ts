...
const PROGRAM = [
  ...
  { time: "17:00 – 17:45", type: "talk", title: "Пять стратегических решений, которые руководитель автобизнеса должен принять, чтобы ИИ работал на капитализацию", speaker: "Кирилл Лядов", company: "" },
  { time: "17:00 – 17:45", type: "talk", title: "Личные и командные ИИ-ассистенты: архитектура новой продуктивности", speaker: "Иван Староастин", company: "" },
